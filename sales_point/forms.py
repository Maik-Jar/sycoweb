...
class FormCrearCotizacion(forms.Form):
    ...
    nombre_cliente = forms.CharField(max_length= 60, label= 'Cliente', widget=forms.TextInput(attrs={'class':'form-control', 'readonly':True}))
    ...
    telefono_cliente = forms.CharField(max_length= 60, label= 'Teléfono', widget=forms.TextInput(attrs={'class':'form-control'}))
...
class FormCrearDetalleCotizacion(forms.ModelForm):
    ...
    class Meta:
        ...
        fields= ['item','descuento_item','cantidad_item']
